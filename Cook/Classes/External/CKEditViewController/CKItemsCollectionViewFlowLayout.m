//
//  CKItemsCollectionViewFlowLayout.m
...
@interface CKItemsCollectionViewFlowLayout ()
...
@implementation CKItemsCollectionViewFlowLayout
...
- (BOOL)animationRequiredForIndexPath:(NSIndexPath *)itemIndexPath {
    return ([self.insertedIndexPaths containsObject:itemIndexPath]
