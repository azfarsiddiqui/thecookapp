//
//  CKCommentEditViewController.m
//  Cook
//
//  Created by Gerald Kim on 23/10/2013.
...
@interface CKCommentEditViewController ()

@property (nonatomic, strong) UIButton *saveButton;
@property (nonatomic, strong) UIButton *cancelButton;
@property (nonatomic, strong) CKEditingTextBoxView *editView;

@end

@implementation CKCommentEditViewController
